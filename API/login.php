...
$data=mysqli_query($con,"SELECT login.username,login.pwd,login.type,parent.status,student.status FROM `login`INNER JOIN student ON login.reg_id= student.stu_id 
