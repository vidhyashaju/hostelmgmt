...
$data=mysqli_query($con,"SELECT * FROM `student`");
    if(isset($_POST['submit'])){
      ...
      $date=date("Y/m/d");
      mysqli_query($con,"INSERT INTO `notification`(`notification`, `stu_id`, `date`) VALUES ('$notification','$studentName','$date')");
    }
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card-body">
                  <form class="form-sample" method="POST">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Notification</label>
                          <div class="col-sm-9">
